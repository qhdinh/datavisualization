class DataReadCombi{
  CountryCombi[] counname;
  Criteria[] criteria;
  Double[] dataset;

  public DataReadCombi(){
    String[] lines = loadStrings(sketchPath("data\\factbook.csv"));
    int i,j;
    counname = new CountryCombi[lines.length-2];
    ...
    for(i=2;i<lines.length;i++){
      ...
      CountryCombi c = new CountryCombi(columns[0],i-2);
      counname[i-2]=c;
